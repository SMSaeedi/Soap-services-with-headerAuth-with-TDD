...
public class PaymentSoapTest {
    ...
    public void testSoap() {
        try {
            URL url = null;
            try {
                url = new URL("http://localhost:8889/ws/Payment?wsdl");
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }

            QName qname = new QName("http://impl.webService.payment.demo.example.com/", "MostRecentOrder");
            Service service = Service.create(url, qname);
            Payment factory = service.getPort(Payment.class);
            ...
            factory.paymentTransaction_Vx0Test();
        } catch (Exception e) {
