...
@SpringBootTest
public class GetPasswordSoapTest {
    ...
    public void testSoap() {
        try {
            URL url = null;
            try {
                url = new URL("http://localhost:8889/ws/GetPassword?wsdl");
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }

            QName qname = new QName("http://impl.webService.getPassword.demo.example.com/", "MostRecentOrder");
            Service service = Service.create(url, qname);
            GetPassword factory = service.getPort(GetPassword.class);
            ...
            factory.getPassword_Vx0Test("310729");
        } catch (Exception e) {
