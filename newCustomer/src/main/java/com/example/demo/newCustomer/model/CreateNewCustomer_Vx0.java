package com.example.demo.newCustomer.model;
...
import static com.example.demo.newCustomer.model.TPCWUtil.DigSyl;
...
public class CreateNewCustomer_Vx0 {
    ...
    public Customer createNewCustomer(Customer cust) {
        ...
        try {
            ...
            Logging.trace("CreateNewCustomer_Vx0: " + ex);
        } finally {
    ...
    private int enterAddress(Connection con, String street1, String street2, String city, String state, String zip, String country) {
        ...
        try {
            ...
            Logging.trace("CreateNewCustomer_Vx0 enterAddress : " + ex);
        }
        return addr_id;
    }

    public NewCustomerOutput test(NewCustomerInput input) {
