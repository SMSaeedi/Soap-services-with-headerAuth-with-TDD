...
import com.example.demo.delivery.object.DistrictDelivery;
...
//                    System.out.println(": No orders to be delivered.\n");
    ...
    public DeliveryResult deliveryTransactionTest(String w_id, String o_carrier_id) {
        DeliveryResult delivery = new DeliveryResult();
        delivery.setW_id(w_id);
        delivery.setO_carrier_id(o_carrier_id);
